...
static AddIn xai_black_put_implied(
	...
	.Arg(XLL_DOUBLE, L"f", L"is the forward.", L"150")
	.Arg(XLL_DOUBLE, L"p", L"is the put price.", L"8.968")
	.Arg(XLL_DOUBLE, L"k", L"is the strike.", L"150")
	.Arg(XLL_DOUBLE, L"t", L"is the time in years to expiration.", L"1")
	.Category(L"XLL")
	.FunctionHelp(L"Return sigma value.")
);
